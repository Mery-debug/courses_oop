...
def point() -> str:
    ...
    vac_2 = vac.sort_by_keywords(vac_1, keywords)
    vac_3 = vac.sort_for_top_n_vacancies(vac_2)
    read = ReadJson("test.json", vac_3)
    read_1 = read.dict_to_json(vac_3, "test.json")
    return read_1
